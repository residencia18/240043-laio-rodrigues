...
class TestePagamento {
    ...
    void testRegistraReembolso() {
        ...
        pagamento.registraReembolso(dataReembolso, valorReembolso, pagamento.getId());
    ...
    void testRegistraReembolsoWithZeroValue() {
        ...
        assertThrows(IllegalArgumentException.class, () -> pagamento.registraReembolso(dataReembolso, valorReembolso, pagamento.getId()));
    }
