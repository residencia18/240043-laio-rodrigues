...
public class Imovel implements Serializable {
	...
	public Imovel(int id, String Matricula, String Endereco, int LeituraAterior, int LeituraAtual, Cliente proprietario) throws Exception {
		setId(id);
		setMatricula(Matricula);
		setEndereco(Endereco);
		setLeituraAterior(LeituraAterior);
	...
	public void setId(int id) throws Exception {
		if(id < 0) throw new Exception("O id não pode ser menor que zero!");
        this.id = id;
	}
