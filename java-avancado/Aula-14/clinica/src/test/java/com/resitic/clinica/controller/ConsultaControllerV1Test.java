...
import com.resitic.clinica.controller.services.ConsultaServiceV1;
...
class ConsultaControllerV1Test {
	...
	@MockBean
	private ConsultaServiceV1 consultaServiceMock;

	@Test
	@DisplayName("Deveria devolver código Http 400 quando informações estão inválidas")
	void testAgendarCenario1() throws Exception {
		MockHttpServletResponse response = mvc.perform(post("/v1/consultas")).andReturn().getResponse();
