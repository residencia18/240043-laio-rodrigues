    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/api/auth/**").permitAll()    //All login and registration requests are permitted.
                        .requestMatchers("/api/password-recovery").permitAll()  //All password recovery requests are permitted.
                        .requestMatchers("/api/password-reset").permitAll()     //All password reset requests are permitted.
