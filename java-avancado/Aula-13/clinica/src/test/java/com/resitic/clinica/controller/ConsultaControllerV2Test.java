...
class ConsultaControllerV2Test {
	...
	@MockBean
	private ConsultaServiceV2 consultaServiceMock;

	@Test
	@DisplayName("Deveria devolver código Http 400 quando informações estão inválidas")
	void testAgendarCenario1() throws Exception {
		MockHttpServletResponse response = mvc.perform(post("/v2/consultas")).andReturn().getResponse();
